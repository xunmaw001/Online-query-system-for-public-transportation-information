<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="站点分类" prop="zhandianfenlei">
          <el-select v-model="ruleForm.zhandianfenlei" placeholder="请选择站点分类">
            <el-option
                v-for="(item,index) in zhandianfenleiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="站点分类" prop="zhandianfenlei">
	      <el-input v-model="ruleForm.zhandianfenlei"
                placeholder="站点分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发车间隔" prop="fachejiange">
          <el-input v-model="ruleForm.fachejiange" 
              placeholder="发车间隔" clearable  :readonly="ro.fachejiange"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发车间隔" prop="fachejiange">
              <el-input v-model="ruleForm.fachejiange" 
                placeholder="发车间隔" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/zhandianfenlei/fenlei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.zhandianfenleiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssm3957q/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
