	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`zhoubianfenlei`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
																																																																																																if(this.ruleForm.id){
					await this.$api.update(`zhoubianfenlei`, this.ruleForm);
				}else{
					await this.$api.add(`zhoubianfenlei`, this.ruleForm);
				}
